...
@Component({
  ...
  standalone: true,
  imports: [NgFor, NgIf, FormsModule, SettingsSectionHeaderComponent, MasterListEditorComponent],
  template: `
    <div class="w-full h-full bg-white dark:bg-erp-surface-dark p-6 rounded-md">
      ...
      <form class="mb-4 flex flex-wrap items-end gap-3" (ngSubmit)="add()">
        <label class="block">
      ...
      <div class="mt-8">
        <app-master-list-editor list="paymentTerms" title="Payment terms" valueLabel="Days" placeholder="e.g. Net 30"
          hint="Terms offered to customers and suppliers."></app-master-list-editor>
      </div>
      <div class="mt-8">
        <app-master-list-editor list="tax" title="Tax rates" valueLabel="Rate %" placeholder="e.g. VAT 5%"
          hint="Tax rates available on products and documents."></app-master-list-editor>
      </div>
      <div class="mt-8">
        <app-master-list-editor list="unit" title="Units of measure" placeholder="e.g. Box"
          hint="Units used for products and quantities."></app-master-list-editor>
      </div>
      <div class="mt-8">
        <app-master-list-editor list="source" title="Enquiry sources" placeholder="e.g. Referral"
          hint="Where an enquiry or lead came from."></app-master-list-editor>
      </div>
      <div class="mt-8">
        <app-master-list-editor list="priority" title="Priorities" placeholder="e.g. High"
          hint="Priority levels for enquiries and follow-ups."></app-master-list-editor>
      </div>
      <div class="mt-8">
        <app-master-list-editor list="industry" title="Industries" placeholder="e.g. Construction"
          hint="Industry classification for customers."></app-master-list-editor>
      </div>
      <div class="mt-8">
        <app-master-list-editor list="enquiryCategory" title="Enquiry categories" placeholder="e.g. Supply only"
          hint="Categories used to group enquiries."></app-master-list-editor>
      </div>
    </div>
  `,
})
