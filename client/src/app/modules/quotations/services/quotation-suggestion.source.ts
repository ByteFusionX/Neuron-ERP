...
import { ItemSuggestion, ItemSuggestionQuery, ItemSuggestionSource } from 'src/app/shared/components/item-entry';
 ...
 */
@Injectable()
export class QuotationSuggestionSource implements ItemSuggestionSource {
