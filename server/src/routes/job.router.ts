...
import { getJobSalesPerson, jobList, totalJob, updateJobStatus, deleteJob, jobSheets, updateAllocateType, getDropdownListForTechnical } from "../controllers/job.controller";
